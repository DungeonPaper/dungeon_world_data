...
List<R> listMapper<R>(List lst, R Function(dynamic obj) mapper) =>
...
List<Move> moveListMapper(List lst) => lst == null || lst.length == 0
    ? <Move>[]
    : listMapper<Move>(lst, (v) => Move.fromJSON(v));
...
Map<String, List<String>> nameMapper(Map map) => mapMapper<List<String>>(
    ...
    (k, v) => MapEntry<String, List<String>>(
        k.toString(), listMapper<String>(v, (j) => j.toString())));
